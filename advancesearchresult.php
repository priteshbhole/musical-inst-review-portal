...
<body>
  ...
  if(empty($pname)||empty($maxprice)||empty($minprice)){
   ...
   //connect  to the database 
    ...
    $sql="SELECT * FROM products WHERE product_name LIKE '%".$pname."%' AND price >= ".$minprice." AND price <=".$maxprice;
  ...
  <div class="smallpadding"></div><div class="smallpadding"></div>
